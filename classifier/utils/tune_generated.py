...
from models.lenet_v2 import LeNet5
...
def tune_trainer(config):
    ...
    coins = r"C:\Users\Mate\Projects\Classifiers\data\generated_iron\full_iron"
    gen_coins = r"C:\Users\Mate\Projects\Classifiers\data\generated_iron\filtered_iron"
    others = r"C:\Users\Mate\Projects\Classifiers\data\others"
    train_set = GeneratedDataset(coin_dir=coins, 
                        gen_dir=gen_coins,
                        others_dir=others, 
                        transform=transforms,
                        gen_image_num=1479)

    test_coins = r"C:\Users\Mate\Projects\Classifiers\data\test_data\coin"
    test_others = r"C:\Users\Mate\Projects\Classifiers\data\test_data\other"
    test_set = IronDataset(coin_dir=test_coins, 
                        others_dir=test_others, 
                        transform=transforms)
    
    #train_set, test_set = torch.utils.data.random_split(dataset, [0.8, 0.2])

    train_loader = DataLoader(train_set, batch_size=config["batch_size"], drop_last=True, shuffle=True, num_workers=0)
    test_loader = DataLoader(test_set, batch_size=config["batch_size"], drop_last=True, shuffle=False, num_workers=0)
...
def main():
    ...
    search_space = {
        ...
        "epochs": tune.grid_search([50, 100, 150]),
    ...
    tuner = tune.Tuner(
        ...
        tune_config=tune.TuneConfig(
            ...
            mode="min",
            num_samples=3,
            scheduler=ASHAScheduler(time_attr="training_iteration", max_t=100, grace_period=10, reduction_factor=2),
        ),
        run_config=train.RunConfig(
            name="generated_filtered_coins",
    ...
    with open(r"C:\Users\Mate\Projects\Classifiers\ray_results\generated_filtered_coins\best_loss.json", "w", encoding='utf-8') as f:
        json.dump(best_loss.metrics, f, ensure_ascii=False, indent=4)
    with open(r"C:\Users\Mate\Projects\Classifiers\ray_results\generated_filtered_coins\best_accuracy.json", "w", encoding='utf-8') as f:
