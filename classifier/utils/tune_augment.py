...
def main():
    ...
    with open(r"C:\Users\Mate\Projects\Classifiers\ray_results\augmented_coins\best_loss.json", "w", encoding='utf-8') as f:
        json.dump(best_loss.metrics, f, ensure_ascii=False, indent=4)
    with open(r"C:\Users\Mate\Projects\Classifiers\ray_results\augmented_coins\best_accuracy.json", "w", encoding='utf-8') as f:
